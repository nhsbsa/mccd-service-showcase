...
<GridRow>
    ...
    <GridColumn width={'3/4'}>
        ...
        'As is' research reviews, usability testing with APs and interviews with registrars and informants.
...
<GridRow>
    ...
    <GridColumn width={'3/4'}>
        ...
        ### In practice, the notice to informant element of the paper form appears to be used infrequently 
        ...
        * 9/10 of our informant participants had collected an MCCD but none were given the 'notice to informant' separated from the MCCD form
        ...
        Our informant research indicates that instructions on needing to register appear to come from a variety of sources from bereavement offices, nurses, midwives; funeral directors.  

        <WarningCallout title={"Mother, Registering Son, Under 28 days"}>
        ...
        <WarningCallout title={"Father, Registering Son's Death, Jewish"}>
        ...
        Before undertaking the informant research, we understood that the MCCD was now largely scanned and sent electronically to the registry office, removing the onus from the informant. This was originally in place as part of the COVID easements and remained in placed afterwards. However, 9/10 of our participants had needed to collect the MCCD. This takes time out of people's days and effort to travel, sometimes to unfamiliar locations. In some cases, it entailed 'chasing' for the MCCD to arrange a registry appointment 

        <WarningCallout title={"Nephew, Registering Uncle, Islam"}>
        ...
        <WarningCallout title={"Daughter, Registering Mother, Sikhism"}>
