...
<GridRow>
    <GridColumn width={'2/3'}>
        <LeadParagraph>
            We conducted primary research with those who'd acted as informants (people who'd registered a death) in the last 3 to 16 months. This allowed us to understand informant experiences related to the MCCD, important interactions during this time and opportunities for improving the process.
        </LeadParagraph>
    </GridColumn>
...
<GridRow>
    ...
    <GridColumn width={'1/2'}>
        <a className="next-page" href="/beta/to-be">
            ...
            Next: <span>Projecting the 'to be'</span>
        </a>
    </GridColumn>
</GridRow>
