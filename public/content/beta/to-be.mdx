        ...
        * Help ensure the registers get the information they need to register the death within 5 days following medical examiner sign off.
        ...
        <Table>
            <TableRow>
                ...
                <TableCell>
                    <ModalImage className="modal-img" alt="A snapshot into an early workshop" small={'/artefacts/images/to-be-workshop-snapshot.png'} medium={'/artefacts/images/to-be-workshop-snapshot.png'} hideZoom />
            ...
            <TableRow>
                ...
                <TableCell>
                    <ModalImage className="modal-img" alt="Later refinement of the service" small={'/artefacts/images/to-be-service-refinement.png'} medium={'/artefacts/images/to-be-service-refinement.png'} hideZoom />
