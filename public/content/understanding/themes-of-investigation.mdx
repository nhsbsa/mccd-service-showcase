...
<GridRow>
    <GridColumn width={'2/3'}>
        <LeadParagraph>
            Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Maecenas sed diam eget risus varius blandit sit amet non magna.
        </LeadParagraph>
    </GridColumn>
...
<GridRow>
    ...
    <GridColumn width={'3/4'}>
        ...
        * Cause of death questions (1a-c, and 2) in a one question per page format
        ...
        <GridRow>
            <GridColumn width={'1/3'}>
                <ZoomImage alt="TBC" small={'https://placehold.co/600x400?text=TBC'} medium={'https://placehold.co/900x600?text=TBC'} />
            </GridColumn>
            <GridColumn width={'1/3'}>
                <ZoomImage alt="TBC" small={'https://placehold.co/600x400?text=TBC'} medium={'https://placehold.co/900x600?text=TBC'} />
            </GridColumn>
        ...
        * This makes completing the MCCD more difficult/slower and increases risk of mistakes. 
        ...
        Expansion text
        We found one page per question was problematic for the cause of death questions (1a, 1b, 1c and part 2). Separating these consistently these caused confusion and created friction in the journey for users, who spent time going and back and forth between the questions, often amending previously inputted content.  

        We tested several variations and found that including all questions (part 1 and 2) on the same page made was most optimal, as it allowed users to tell a cohesive narrative which build from question to question. 
        ...
        * Allowing users to specify the unit of measurement.
        ...
        Expansion text  
        This was after receiving feedback from users that placing the time of onset under the field it relates to is confusing, we've moved this to the same row. We've also tested how we might improve data accuracy for ONS, by including units of measurement in the time field.  This still requires further testing. 
...
<GridRow>
    ...
    <GridColumn width={'3/4'}>
        ...
        * Following the last alpha assessment, we focused more on how a digital MCCD could fit into the wider DCR journey.
        ...
        Expansion text  
        In the initial alpha, we spent time focusing on understanding questions within the form. Considering the various points of interactions between APs and MEs during the course on an MCCD scrutiny, we needed to explore how these handoffs could happen. 

        ### This relates to user needs of 'knowing when to act' 

        * As an AP, I need to know when an MEO or ME want me to make an edit to the MCCD so that I do not cause delays in the MCCD being sent to the registrar. 
        * As an ME, I need to know when an MCCD is ready for scrutiny, so that I can review the MCCD and respond accordingly.  
        ...
        <GridRow>
            <GridColumn width={'full'}>
                <ZoomImage alt="TBC" small={'https://placehold.co/600x200?text=TBC'} medium={'https://placehold.co/900x300?text=TBC'} />
            </GridColumn>
        </GridRow>
        ...
        * Mental models and reception of the ideas varied – depending on how sophistication of existing processes and systems
        * We need to develop a product that is flexible enough to work irrespective of system sophistication
        * We need to consider the role of MEOs in the process
        ...
        <GridRow>
            <GridColumn width={'full'}>
                <ZoomImage alt="TBC" small={'https://placehold.co/800x320?text=TBC'} medium={'https://placehold.co/1000x400?text=TBC'} />
            </GridColumn>
        </GridRow>

        Both options seemed viable from usability and concept testing, though participants tended to report preferring the dashboard design as relying solely on emails might result in missed actions or a degree of distrust  
...
<GridRow>
    ...
    <GridColumn width={'3/4'}>
        ...
        Here we explored how we might reduce administrative burden for our users and support MCCD completers to submit more accurate MCCDs first time.
        ...
        * integrate with the Personal Demographics Service (PDS) 
        ...
        Expansion text  
        We found whilst some users know their work postcode, some are more familiar with the first line of the address. In future, we will explore whether allowing either postcode or partial address is feasible/increases usability. 

        We've also been in contact with the Personal Demographics Service (PDS) team as we plan to explore integrating with PDS via API, to increase speed and accuracy of data entered, relating to the deceased's information. 
...
<GridRow>
    ...
    <GridColumn width={'3/4'}>
        ...
        MCCDs queries and rejections are a key pain point across our user groups that cause rework for professionals involved in the death registration process and delays for those handling the deceased's funeral.  

        Expansion text  
        There can be a range of reasons from queries on handwritten content to missing information and challenge to the cause of death listed. During this Alpha, we considered how we might reduce this occurrence of these. 

        ### This relates to user needs of 'accuracy' and 'receiving help' 

        * As an AP I need to complete the MCCD accurately first time, so I don't have to waste my time re-doing it causing delays to others.
        * As an AP who does not complete MCCDs very often, I need help to complete the details of an MCCD outside of the COD so that silly mistakes such as abbreviations, and missing GMC number, do not cause the registrar to reject the MCCD and delay the informant from registering the death.
        * As an AP with less experience of completing MCCDs, I need help to correctly write then MCCD, so that it does not get rejected and delay the informant from registering the death.
        ...
        We worked closely with stakeholders such as GRO, ONS and the Welsh Government to determine the MCCD question protocol. This not only allowed us to remove unnecessary fields (for example, AP qualifications). It also allowed us to identify where fields were mandatory and use logic to help users reduce omissions that would cause an MCCD to be rejected/rework for the AP.

        <GridRow>
            <GridColumn width={'full'}>
                <ZoomImage alt="TBC" small={'https://placehold.co/800x200?text=TBC'} medium={'https://placehold.co/800x200?text=TBC'} />
            </GridColumn>
        </GridRow>

        Knowing that using an unacceptable cause of death (for example,  'old age') is a key reason for registrars to reject, we considered how we could support APs to document a legitimate cause of death on an MCCD, first time. We consider using the Royal College of Pathologists' 'Cause of Death List' to provide a. prepopulated list for APs to choose from. This was something APs themselves has suggested would be helpful.  
